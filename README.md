...
\[!\[Project Status: WIP](https://img.shields.io/badge/Status-Work\_in\_Progress-yellow.svg)](https://github.com/jillanes-va/dccs-gold-thesis)

\[!\[Python: >=3.11](https://img.shields.io/badge/Python-3.11+-blue.svg)](https://www.python.org/)

\[!\[Package Manager: uv](https://img.shields.io/badge/Environment-uv-purple.svg)](https://github.com/astral-sh/uv)

\[!\[R: >=4.3](https://img.shields.io/badge/Analysis-R-blue.svg)](https://www.r-project.org/)

\[!\[Institution: DCCS UDD](https://img.shields.io/badge/Institution-DCCS\_UDD-red.svg)](https://dccs.udd.cl/)
...
&#x20; \*(Asignación formal de roles de profesor guía y co-guía en proceso de definición administrativa)\*
...
\* `r\_models/`: Scripts de R para estimación econométrica, pruebas de robustez y análisis residual.
